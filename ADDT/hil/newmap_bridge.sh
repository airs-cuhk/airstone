...
roslaunch carla_ros_bridge carla_ros_bridge_with_example_ego_vehicle.launch spawn_point:=4.4,48.3,0.5,0,0,0
#roslaunch carla_ros_bridge carla_ros_bridge_with_example_ego_vehicle.launch
#roslaunch carla_ros_bridge carla_ros_bridge_with_example_ego_vehicle.launch spawn_point:=58.8,-78.2,0.5,0,0,180 role_name:=test_vehicle_1
